...
-- Dumping data for table refund.10_form_rules: ~2 rows (approximately)
/*!40000 ALTER TABLE `10_form_rules` DISABLE KEYS */;
REPLACE INTO `10_form_rules` (`id`, `form_id`, `order`, `name`, `sub_of`, `rule_type`, `result_type`, `status`, `created_at`, `updated_at`) VALUES
	(1, 1, 1, 'Rule 2', 0, 1, 1, 1, '2019-04-07 05:28:40', '2019-04-07 06:00:11'),
	(2, 1, 1, 'Rule 2', 0, 1, 1, 1, '2019-04-07 05:28:48', '2019-04-07 06:00:28');
...
REPLACE INTO `11_form_conditions` (`id`, `form_rule_id`, `order`, `name`, `condition_type`, `status`, `created_at`, `updated_at`) VALUES
	(1, 1, 1, 'Condition 1', 1, 1, '2019-04-07 07:11:32', '2019-04-07 07:20:04'),
	(2, 1, 2, 'Condition 2', 1, 1, '2019-04-07 07:18:33', '2019-04-07 07:18:33'),
	(3, 2, 1, 'Condition 1', 1, 1, '2019-04-07 07:20:30', '2019-04-07 07:20:30');
...
REPLACE INTO `5_contract_time_edits` (`id`, `refund_id`, `order`, `approve_date`, `edit_type`, `edit_detail`, `edit_days`, `created_at`, `updated_at`) VALUES
...
REPLACE INTO `6_delivers` (`id`, `refund_id`, `order`, `detail`, `overdue_days`, `deliver_date`, `penalty`, `created_at`, `updated_at`) VALUES
...
REPLACE INTO `7_deposit_penalties` (`id`, `refund_id`, `order`, `deposit_no`, `deposit_date`, `amount`, `created_at`, `updated_at`) VALUES
...
REPLACE INTO `8_approve_refunds` (`id`, `refund_id`, `receive_refund_date`, `approve_refund_days`, `approve_refund_amount`, `amount`, `created_at`, `updated_at`) VALUES
	(1, 1, '2019-01-31', 30, 20.20, 200.20, '2019-04-02 09:02:41', '2019-04-02 09:33:10');
/*!40000 ALTER TABLE `8_approve_refunds` ENABLE KEYS */;

-- Dumping data for table refund.9_forms: ~2 rows (approximately)
/*!40000 ALTER TABLE `9_forms` DISABLE KEYS */;
REPLACE INTO `9_forms` (`id`, `name1`, `name2`, `name3`, `create_by`, `status`, `created_at`, `updated_at`) VALUES
	(1, 'Form 1', 'This is form two', 'The Form', 'Songwut', 1, '2019-04-03 12:09:01', '2019-04-03 12:09:01'),
	(2, 'Form 2', 'This is form two', 'The Form', 'Songwut', 1, '2019-04-07 06:04:58', '2019-04-07 06:04:58');
