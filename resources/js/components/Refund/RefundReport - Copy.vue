        ...
        <b-row>
            <b-col>
                <div class="book" id="book" ref="book">
                    <div class="page" id="printThis" v-if="false">
                                                ...
                                                <td>
                                                    <div class="main_order" v-for="contract in refund.refund.contracts" :key="contract.id">
                                                        ...
                                                        <div class="sub_order">
                                                            ...
                                                            <p class="head sub">วงเงินในสัญญาา <span class="show">{{contract.budget | numeral('0,0.00')}} </span>บาท  อัตราค่าปรับ <span class="show">{{contract.penalty_per_day | numeral('0,0.00')}} </span>บาท</p>
                        ...
                        <div class="subpage" v-if="isReady">
                            <b-row align-h="center">
                                <b-col cols="12" class="form_name">
                                    <p class="topic mt-4">รายการเอกสารที่ต้องจัดเตรียม</p>
                                </b-col>
                            </b-row>
                            <b-row align-h="center">
                                <b-col cols="8">
                                    <table>
                                        <thead>
                                            <tr>
                                                <th scope="col" style="width: 40%">ประเภทเอกสาร</th>
                                                <th scope="col" style="width: 60%">รายการเอกสาร</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td>1. เอกสารสัญญา</td>
                                                <td>1.1 สัญญาเลขที่ <span class="show-list">{{refund.refund.contracts[0].contract_no}}</span>  ลงวันที่ <span class="show-list">{{getThaiDate(refund.refund.contracts[0].contract_date)}}</span></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </b-col>
