                                        ...
                                        <tbody>
                                                    ...
                                                    <div class="main_order">
                                                        ...
                                                        <div v-if="time_edits && time_edits.length > 0">
                                                            <div v-for="(time_edit,index) in time_edits" :key="index">
                                                                ...
                                                                <p class="head sub2" v-if="parseInt(time_edit.approve_type) == 41">โดยได้รับผลกระทบจากกรณีโรคโควิด 19<br> ในช่วงเวลาตั้งแต่วันที่ : <span class="show">{{getThaiDate(time_edit.problem_end_date)}}</span> ถึงวันที่ <span class="show">{{getThaiDate(time_edit.book_date)}}</span></p>
                                                                <p class="head sub2" v-if="parseInt(time_edit.approve_type) == 42">เข้าตามหลักเกณฑ์และเงื่อนไขในข้อ : <span class="show">{{time_edit.zero_penalty_consider}}</span></p>
                                                                <p class="head sub2" v-if="parseInt(time_edit.approve_type) == 42">ตามสัญญาแก้ไข/บันทึกแนบท้าย : <span class="show">{{time_edit.zero_penalty_detail}}</span></p>
                                                            </div>
                                                        </div>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    ...
                                                    <div class="head sub">(ระดับชำนาญการพิเศษขึ้นไป หรือเทียบเท่า)</div>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
