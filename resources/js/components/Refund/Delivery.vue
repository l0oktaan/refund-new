        ...
        <my-alert :AlertType="alert"></my-alert>
            ...
            <b-form @submit.stop.prevent="passes(onSubmit)">
                        ...
                        <b-row  v-if="hasPenalty" class="animated fadeIn fadeOut">
                            ...
                            <b-col cols="3">
                                <b-form-group>
                                    <label for="penalty">จำนวนเงินที่ต้องปรับ : {{currency_unit == 'THB' ? '(บาท)' : '(ดอลลาร์สหรัฐ)'}} <span class="require">*</span></label>
                            ...
                            <b-col cols="3">
                                <b-form-group>
                                    <label for="penalty">จำนวนเงินที่ปรับไว้ : {{currency_unit == 'THB' ? '(บาท)' : '(ดอลลาร์สหรัฐ)'}} <span class="require">*</span></label>
