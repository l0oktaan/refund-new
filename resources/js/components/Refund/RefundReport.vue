                                                ...
                                                <td>
                                                    <div class="main_order">
                                                            ...
                                                            <div v-for="(approve,index) in approves" :key="index">
                                                                ...
                                                                <p class="head sub"><span>หน่วยงานอนุมัติคืนค่าปรับ จำนวน <span class="show">{{approve.refund_money}} </span> วัน</span> เป็นเงิน <span class="show">{{approve.refund_amount | numeral('0,0.00')}}</span> บาท</p>
                                                                <p class="head sub"></p>
