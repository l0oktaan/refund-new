                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="width: 435px">
                                                    <div class="main_order">
                                                        ...
                                                        <div v-for="(deliver,index) in delivers" :key="index">
                                                            ...
                                                            <p class="head sub2" v-if="deliver.overdue_days">คิดค่าปรับ <span class="show">{{deliver.overdue_days}}</span> วัน ถูกปรับเป็นเงิน <span class="show">{{deliver.penalty_accept | numeral('0,0.00')}}</span>{{refund.refund.contracts[0].currentcy_unt == 'THB' ? 'บาท' : 'ดอลลาร์สหรัฐ'}}</p>                                                            
                                                        </div>
                                                    </div>
                                                </td>
                                                ...
                                                <td style="width: 270px">
                                                    ...
                                                    <p class="head">รวมเป็นเงินค่าปรับ <span class="show">{{getPenaltyAcceptAll() | numeral('0,0.00')}}</span> {{refund.refund.contracts[0].currentcy_unt == 'THB' ? 'บาท' : 'ดอลลาร์สหรัฐ'}}</p>
                                                    <p class="head" v-if="(getPenaltyAll() != getPenaltyAcceptAll()) && getPenaltyAll() > 0 ">ตามข้อเท็จจริงต้องปรับไว้ <span class="show">{{getPenaltyAll() | numeral('0,0.00')}}</span> {{refund.refund.contracts[0].currentcy_unt == 'THB' ? 'บาท' : 'ดอลลาร์สหรัฐ'}}</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
